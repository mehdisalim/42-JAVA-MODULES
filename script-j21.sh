...
# Eclipse Temurin JDK 21 LTS, macOS x64 build.
JAVA_MAJOR="21"
...
# --- Java ----------------------------------------------------------------
echo "==> Downloading Java (Temurin ${JAVA_MAJOR} LTS, macOS x64)..."
...
# Resolve the extracted JDK folder dynamically.
JDK_HOME="$(find "${INSTALL_DIR}" -maxdepth 1 -type d -name 'jdk-21*' | head -n1)/Contents/Home"
